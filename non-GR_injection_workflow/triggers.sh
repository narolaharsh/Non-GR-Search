BANKNAME='GRBank-2405'
START_TIME=1126086042
END_TIME=1126431642
...
--order 8 \
--gating-file H1-GATES_1126051217-11203200.txt \
--snr-threshold 5.5 \
--chisq-bins 16 \
...
--bank-file /home/narola.bharatbhai/templatebank/xml-bank-2405/GRBank-2405.xml.gz \
--output ${BANKNAME}_${START_TIME}_${ENDTIME}_GR.hdf \
--verbose
