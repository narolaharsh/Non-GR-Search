...
--trig-start-time 1124384409 \
--trig-end-time 1124384413 \
--frame-type H1_HOFT_C00 \
--injection-file hwinjcbc_1124384411.xml.gz \
--bank-file hwinjcbc_1124384411.xml.gz \
--output one-inj-output-geo-cent.hdf \
--verbose
