...
def set_default_constraints(constraints):
    ...
    known_constraints = ["mass1", "mass2", "mratio", "mtotal", "mchirp",
                         "spin1", "spin2", "duration", "deltaChi1", "deltaChi2", "deltaChi3", "deltaChi4"]
...
#def non_gr_param_generator(**kwargs):
...
def aligned_spin_param_generator(flow, tmplt_class, bank, **kwargs):
    ...
    """
    deltaChi1_min, deltaChi1_max = kwargs.pop('deltaChi1', (0.0, 0.0))
    deltaChi2_min, deltaChi2_max = kwargs.pop('deltaChi2', (0.0, 0.0))
    deltaChi3_min, deltaChi3_max = kwargs.pop('deltaChi3', (0.0, 0.0))
    deltaChi4_min, deltaChi4_max = kwargs.pop('deltaChi4', (0.0, 0.0))
    ...
    for mass1, mass2 in urand_tau0tau3_generator(flow, **kwargs):
        ...
        deltaChi1 = uniform(deltaChi1_min, deltaChi1_max)
        deltaChi2 = uniform(deltaChi2_min, deltaChi2_max)
        deltaChi3 = uniform(deltaChi3_min, deltaChi3_max)
        deltaChi4 = uniform(deltaChi4_min, deltaChi4_max)
        
        t = tmplt_class(mass1, mass2, spin1, spin2, deltaChi1, deltaChi2, deltaChi3, deltaChi4, bank=bank)
