...
from tau0tau3 import proposals
from psds import noise_models, read_psd, get_PSD
from waveforms import waveforms, SnglInspiralTable
...
def parse_command_line():
    ...
    #
    # nonGR parameters options
    #
    parser.add_option("--deltaChi1-min", help="Set minimum allowed value of 0.5PN deviation.", type="float", default = 0.0, metavar="nonGRParams")
    parser.add_option("--deltaChi1-max", help="Set maximum allowed value of 0.5PN deviation.", type="float", default = 0.0, metavar="nonGRParams")
    parser.add_option("--deltaChi2-min", help="Set minimum allowed value of 1.0PN deviation.", type="float", default = 0.0, metavar="nonGRParams")
    parser.add_option("--deltaChi2-max", help="Set maximum allowed value of 1.0PN deviation.", type="float", default = 0.0, metavar="nonGRParams")
    parser.add_option("--deltaChi3-min", help="Set minimum allowed value of 1.5PN deviation.", type="float", default = 0.0, metavar="nonGRParams")
    parser.add_option("--deltaChi3-max", help="Set maximum allowed value of 1.5PN deviation.", type="float", default = 0.0, metavar="nonGRParams")
    parser.add_option("--deltaChi4-min", help="Set minimum allowed value of 2.0PN deviation.", type="float", default = 0.0, metavar="nonGRParams")
    parser.add_option("--deltaChi4-max", help="Set maximum allowed value of 2.0PN deviation.", type="float", default = 0.0, metavar="nonGRParams")
...
if opts.trial_waveforms:
    ...
    params = {'mass1': (opts.mass1_min, opts.mass1_max),
          ...
          'deltaChi1': (opts.deltaChi1_min, opts.deltaChi1_max),
          'deltaChi2': (opts.deltaChi2_min, opts.deltaChi2_max),
          'deltaChi3': (opts.deltaChi3_min, opts.deltaChi3_max),
          'deltaChi4': (opts.deltaChi4_min, opts.deltaChi4_max)}
